            ...
            <Card key={t.key} className="border-white/10 bg-white/5">
              <CardHeader className="flex flex-col items-center text-center">
                <CardTitle className="flex w-full flex-col items-center gap-2">
                  ...
                  <Badge className="mx-auto inline-flex h-7 min-w-[140px] items-center justify-center whitespace-nowrap border border-white/10 bg-black/30 px-3 text-center text-white">
                    {t.badge}
                  </Badge>
                </CardTitle>
